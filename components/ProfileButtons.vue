<template>
  <div>
    ...
    <div class="ma-1"><v-btn alt="Portfolio" color="#328723" elevation="2" x-large href="" class="white--text"><v-icon class="ma-1">mdi-book-open-outline</v-icon>Portfolio</v-btn></div>
